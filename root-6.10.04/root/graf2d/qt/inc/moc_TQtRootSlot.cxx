...
#include "../../../../graf2d/qt/inc/TQtRootSlot.h"
...
static const char qt_meta_stringdata_TQtRootSlot[] = {
    "TQtRootSlot\0\0error\0Error(int)\0"
    "ProcessLine(const char*)\0ProcessLine(QString)\0"
    "EndOfLine()\0status\0Terminate(int)\0"
    "Terminate()\0TerminateAndQuit()\0"
};
...
const QMetaObjectExtraData TQtRootSlot::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TQtRootSlot::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TQtRootSlot,
      qt_meta_data_TQtRootSlot, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TQtRootSlot::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TQtRootSlot))
