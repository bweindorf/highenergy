...
#include "../../../../graf2d/qt/inc/TQtClientFilter.h"
...
static const char qt_meta_stringdata_TQtClientFilter[] = {
    "TQtClientFilter\0\0AppendButtonGrab(TQtClientWidget*)\0"
    "RemoveButtonGrab(QObject*)\0"
};
...
const QMetaObjectExtraData TQtClientFilter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TQtClientFilter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TQtClientFilter,
      qt_meta_data_TQtClientFilter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TQtClientFilter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TQtClientFilter))
